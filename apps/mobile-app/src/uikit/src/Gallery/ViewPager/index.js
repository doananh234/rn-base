...
export default class ViewPagerComponent extends PureComponent {
    static propTypes = {
        ...View.propTypes,
    ...
    onPageChanged (page) {
        if (this.currentPage !== page) {
            ...
            this.paginationRef?.current?.onChangeIndex(page);
        }
    }
    ...
    render () {
        ...
        return (
            <View
              ...
              />
              <Pagination ref={this.paginationRef} initialPage={this.props.initialPage} data={pageDataArray} />
            </View>
        );
    }
}
